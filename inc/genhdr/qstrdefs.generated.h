...
QDEF(MP_QSTR_d3_colon_1, (const byte*)"\x19\x04" "d3:1")
...
QDEF(MP_QSTR_d_hash_4_colon_2, (const byte*)"\x7e\x05" "d#4:2")
QDEF(MP_QSTR_g3, (const byte*)"\x31\x02" "g3")
...
QDEF(MP_QSTR_c_hash_4, (const byte*)"\x71\x03" "c#4")
QDEF(MP_QSTR_f_hash_4_colon_2, (const byte*)"\x7c\x05" "f#4:2")
QDEF(MP_QSTR_c_colon_8, (const byte*)"\x04\x03" "c:8")
QDEF(MP_QSTR_c_colon_2, (const byte*)"\x0e\x03" "c:2")
QDEF(MP_QSTR_r3_colon_2, (const byte*)"\xcc\x04" "r3:2")
...
QDEF(MP_QSTR_e3_colon_1, (const byte*)"\xb8\x04" "e3:1")
...
QDEF(MP_QSTR_c3_colon_1, (const byte*)"\x7e\x04" "c3:1")
...
QDEF(MP_QSTR_b2, (const byte*)"\x95\x02" "b2")
...
QDEF(MP_QSTR_c4_colon_2, (const byte*)"\xfa\x04" "c4:2")
QDEF(MP_QSTR_c2_colon_2, (const byte*)"\xfc\x04" "c2:2")
QDEF(MP_QSTR_c_hash_4_colon_1, (const byte*)"\x3a\x05" "c#4:1")
QDEF(MP_QSTR_b3_colon_2, (const byte*)"\xdc\x04" "b3:2")
QDEF(MP_QSTR_b3_colon_1, (const byte*)"\xdf\x04" "b3:1")
QDEF(MP_QSTR_c_hash_4_colon_2, (const byte*)"\x39\x05" "c#4:2")
...
QDEF(MP_QSTR_d4_colon_2, (const byte*)"\x1d\x04" "d4:2")
