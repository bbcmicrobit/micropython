...
QDEF(MP_QSTR__13_333kHz, (const byte*)"\x6d\x0a" "_13_333kHz")
QDEF(MP_QSTR__10kHz, (const byte*)"\xe2\x06" "_10kHz")
QDEF(MP_QSTR__8kHz, (const byte*)"\x5b\x05" "_8kHz")
QDEF(MP_QSTR__6_667kHz, (const byte*)"\x5d\x09" "_6_667kHz")
QDEF(MP_QSTR__5_714kHz, (const byte*)"\xfb\x09" "_5_714kHz")
QDEF(MP_QSTR__5kHz, (const byte*)"\xb6\x05" "_5kHz")
QDEF(MP_QSTR__4_444kHz, (const byte*)"\xfc\x09" "_4_444kHz")
QDEF(MP_QSTR__4kHz, (const byte*)"\xd7\x05" "_4kHz")
