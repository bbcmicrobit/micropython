...
QDEF(MP_QSTR_remove_scanner, (const byte*)"\xba\x0e" "remove_scanner")
QDEF(MP_QSTR_tick, (const byte*)"\x30\x04" "tick")
QDEF(MP_QSTR_tick_once, (const byte*)"\x68\x09" "tick_once")
QDEF(MP_QSTR_when_button_a_pressed, (const byte*)"\x1f\x15" "when_button_a_pressed")
QDEF(MP_QSTR_when_button_b_pressed, (const byte*)"\x1c\x15" "when_button_b_pressed")
QDEF(MP_QSTR_when_compass_between, (const byte*)"\xeb\x14" "when_compass_between")
QDEF(MP_QSTR_when_accelerometer_x_between, (const byte*)"\x67\x1c" "when_accelerometer_x_between")
QDEF(MP_QSTR_when_accelerometer_y_between, (const byte*)"\xa6\x1c" "when_accelerometer_y_between")
QDEF(MP_QSTR_when_accelerometer_z_between, (const byte*)"\x65\x1c" "when_accelerometer_z_between")
