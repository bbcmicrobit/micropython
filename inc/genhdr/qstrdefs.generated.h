...
QDEF(MP_QSTR_like, (const byte*)"\x2e\x04" "like")
QDEF(MP_QSTR_events, (const byte*)"\x9a\x06" "events")
QDEF(MP_QSTR_badaboom, (const byte*)"\x2c\x08" "badaboom")
QDEF(MP_QSTR_do_something, (const byte*)"\x99\x0c" "do_something")
QDEF(MP_QSTR_next_event, (const byte*)"\x11\x0a" "next_event")
